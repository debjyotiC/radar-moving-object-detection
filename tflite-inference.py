...
model_path = f"saved-tflite-model/range-doppler-tent-3-{type_of_quantization}.tflite"

range_doppler_features = np.load("data/npz_files/umbc_tent_3_cfar.npz", allow_pickle=True)
