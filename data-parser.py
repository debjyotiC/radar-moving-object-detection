...
dataset_path = 'data/range-doppler-data'
...
np.savez('data/npz_files/umbc.npz', out_x=data_range_x, out_y=data_range_y)
np.savez('data/npz_files/umbc_cfar.npz', out_x=data_range_cfar_x, out_y=data_range_y)
